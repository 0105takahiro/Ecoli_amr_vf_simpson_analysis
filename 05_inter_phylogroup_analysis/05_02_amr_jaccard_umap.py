...
AMR_DISTANCE_MATRIX_CSV = ROOT / "output" / "03_distance" / "genotype_distance" / "genotypic_distance_matrix_all_phylogroups" / "amr_jaccard_distance_matrix_all_phylogroups.csv"
...
plt.savefig(FIGURE_OUTPUT_DIR / "umap_amr_jaccard.pdf", dpi=600, bbox_inches='tight',pad_inches=0.0)

# ----------------------------
# Legend-only figure
# ----------------------------
handles, labels = ax.get_legend_handles_labels()
fig_legend = plt.figure(figsize=(0.6, 1.5))
...
plt.axis('off')
plt.savefig(
    FIGURE_OUTPUT_DIR / "umap_legend.pdf",
    dpi=600,
    bbox_inches='tight',
    pad_inches=0.0
    )
