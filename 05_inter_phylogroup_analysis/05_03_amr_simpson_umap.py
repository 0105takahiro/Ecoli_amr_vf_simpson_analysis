...
PHYLOGROUP_CSV = ROOT / "output" / "preparation" /"ecoli_genomes_filtered_25080_phylogroup_ok.csv"
AMR_CSV = ROOT / "output" / "amr_and_vf_genes" / "amr_genes_presence_absence_ok.csv"
