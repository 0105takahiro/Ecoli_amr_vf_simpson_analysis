...
plt.tight_layout()
plt.savefig(OUTPUT_DIR_2 / "triangle_heatmap_amr_2.pdf", dpi=600, bbox_inches='tight')
...
fig.subplots_adjust(left=0.05, right=0.95)
plt.tight_layout()
plt.savefig(OUTPUT_DIR_2 / "triangle_heatmap_vf_2.pdf", dpi=600, bbox_inches='tight')
...
fig.savefig(
    OUTPUT_DIR_2 / "legend_for_triangle_heatmap2.pdf",
