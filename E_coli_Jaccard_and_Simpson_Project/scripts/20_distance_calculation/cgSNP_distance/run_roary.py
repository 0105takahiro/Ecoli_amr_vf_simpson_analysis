...
def run_roary_for_phylogroup(phylogroup_name):
    ...
    PROJECT_DIR = (OUTPUT_DIR / "output_prokka"/ f"prokka_output_{phylogroup_name.lower()}").resolve()
    ROARY_OUTPUT_DIR = (OUTPUT_DIR / "roary_output" / f"roary_output_{phylogroup_name.lower()}").resolve()
