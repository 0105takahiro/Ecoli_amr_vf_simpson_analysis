...
# ---- Fixed paths & filenames ----
ROOT     <- "/Users/sekinetakahiro/reserch/E_coli_Jaccard_and_Simpson_Project"
DIST_DIR <- file.path(ROOT, "Output", "distance_matrix_all_phylogroups")
PREPARATION_DIR <- file.path(ROOT, "Output", "Preparation")
PHYLOGROUP_CSV  <- "ecoli-genomes_filtered_25080_phylogroup.csv"
...
# ---- Main ----
phy <- read_phylogroup_base(file.path(PREPARATION_DIR, PHYLOGROUP_CSV))
