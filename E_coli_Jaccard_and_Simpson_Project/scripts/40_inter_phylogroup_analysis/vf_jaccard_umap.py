...
VF_CSV = ROOT / "output" / "amr_and_vf_genes_ok" / "vf-genes-presence-absence.csv"
...
plt.tight_layout()
plt.savefig( FIGURE_OUTPUT_DIR / "umap_projection_vf_jaccard.pdf" , dpi=600, bbox_inches="tight")
