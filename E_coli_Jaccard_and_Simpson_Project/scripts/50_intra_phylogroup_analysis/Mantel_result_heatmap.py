...
# ============================================================
fig = plt.figure(figsize=(2.35, 3.35))  # Narrower width, slightly taller height
...
plt.tight_layout()
plt.savefig(OUT_FIGURE, dpi=600)

# ============================================================
# Generate colorbar panel
# ============================================================
fig_cb, ax_cb = plt.subplots(figsize=(0.22, 1.6))
...
# Add vertical label
ax_cb.set_ylabel("Spearman’s ρ", fontsize=9, rotation=90, labelpad=10)
